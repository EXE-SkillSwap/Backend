...
namespace SkillSwap.Services.Implement
{
    public class PartnerShipService : IPartnerShipService
    {
        ...
        public PartnerShipService(IGenericRepository<PartnerShip> partnerShipRepository, IUnitOfWork unitOfWork, IGenericRepository<UserAccount> userAccountRepository)
        {
