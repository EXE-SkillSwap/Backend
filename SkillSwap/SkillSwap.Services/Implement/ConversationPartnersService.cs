    ...
    public class ConversationPartnersService : IConversationPartnersService
    {
        ...
        public async Task<ResponseDTO> AddMemberToGroup(Guid conversationId, Guid userId)
        {
            ...
            try
            {
                ...
                {
                    dto.IsSucess = false;
                    dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.CONVERSATION_NOT_FOUND;
                    return dto;
                }
                ...
                dto.IsSucess = true;    
                dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.INSERT_SUCESSFULLY;
                dto.Data = newMenber;
            }
            catch (Exception)
            {
                dto.IsSucess = false;
                dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.EXCEPTION;
            }
            return dto;
        }
        ...
        public async Task<ResponseDTO> GetConversationMembers(Guid conversationId)
        {
            ...
            try
            {
                var members = await _conversationPartnerRepository.GetAllDataByExpression(
                    ...
                    null,
                    true,
                    includes: m => m.UserAccount
                    );

                dto.IsSucess = true;
                dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.GET_DATA_SUCCESSFULLY;
                dto.Data = members;
            }
            catch (Exception)
            {
        ...
        public async Task<ResponseDTO> LeaveGroup(Guid conversationId, Guid userId)
        {
            ...
            try
            {
                ...
                {
                    dto.IsSucess = false;
                    dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.AUTH_NOT_FOUND;
                    return dto;
                }
                ...
                dto.IsSucess = true;
                dto.BusinessCode = Commons.DTO.BusinessCode.BusinessCode.CANCEL_SUCCESSFULLY;
